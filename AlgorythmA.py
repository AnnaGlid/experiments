...
def algorythm_a(list_of_agents=None, list_of_rules=None, rule_and_number=None):
    ...
    if rule_and_number is None:
        ...
        if list_of_agents is None or list_of_rules is None:
            raise ValueError("""If rule_and_number is None, 
            list_of_agents and list_of_rules cannot be None""")
